    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>
                ...
                pada <span class="highlight">{{ $tanggalMulai }}</span> <span class="highlight kalasewa-color"> Telah
                    dibatalkan secara otomatis</span>
                karena sudah
                melebihi batas maksimal pengiriman yaitu hari kemarin (H-1 Tanggal Mulai Penyewaan).
            </p>
            <p>
                <span class="highlight">Produk tersebut sekarang memiliki status "arsip". Mohon aktifkan produk secara
                    manual melalui menu produk agar dapat disewa kembali</span>
            </p>
            <p>
