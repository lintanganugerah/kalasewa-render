...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col align-self-center">
                            <a href="{{ route('seller.penarikan.viewTarikSaldo') }}" class="btn btn-danger m-2">Tarik
                                Saldo</a>
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col">
                    ...
                    <script id="dailyIncomeData" type="application/json">@json($dailyIncome)</script>
                    {{-- <script id="yearlyIncomeData" type="application/json">@json($yearlyIncome)</script>
            <script id="dailyIncomeData" type="application/json">@json($dailyIncome)</script> --}}
                </div>
                <div class="col">
                    <div>
                    ...
                    <script id="monthlyIncomeData" type="application/json">@json($monthlyIncome)</script>
                </div>
                <div class="col">
                    <div>
                                        ...
                                        <td data-title="Total Penghasilan" class="align-middle">
                                            @if (
                                                ...
                                                <p><a onclick="toggleModal()" class="text-danger  btnDetailPenghasilan"
                                                        ...
                                                        data-totalpenghasilan="{{ $ord->total_penghasilan }}">Lihat
                                                        Detail
                                                        Penghasilan</a></p>
    ...
    <div class="modal fade" id="unduhLaporanModal" tabindex="-1" aria-labelledby="unduhLaporanModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('export_pdf') }}" method="GET">
    ...
    <script src="{{ asset('seller/chartKeuangan.js') }}"></script>
@endsection
